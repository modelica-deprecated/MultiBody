...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td><a href=\"Modelica:MultiBody.Frames.Quaternions\">Quaternions</a></td>
      <td><b>Package</b> with functions to transform rotational frame quantities based
          on quaternions (also called Euler parameters).
      </td>
  </tr>
  <tr><td><a href=\"Modelica:MultiBody.Frames.TransformationMatrices\">TransformationMatrices</a></td>
      <td><b>Package</b> with functions to transform rotational frame quantities based
...
and/or a division by zero will occur.
  ...
  function axesRotations
    ...
    import TM = MultiBody.Frames.TransformationMatrices;
    extends Modelica.Icons.Function;
