...
<IMG SRC=\"../Images/Examples/Systems/r3_fullRobot.png\" ALT=\"model Examples.Loops.Systems.RobotR3.fullRobot\">
  ...
  package Components "Library of components of the robot"
    ...
    connector AxisBus "Data bus for one robot axis"
      ...
      Interfaces.BooleanPort motion_ref
        "true, if reference motion is not in rest";
      Interfaces.RealPort angle_ref(redeclare type SignalType = SI.Angle)
        "reference angle of axis flange";
      Interfaces.RealPort angle(redeclare type SignalType = SI.Angle)
        "angle of axis flange";
      Interfaces.RealPort speed_ref(redeclare type SignalType =
            SI.AngularVelocity) "reference speed of axis flange";
      Interfaces.RealPort speed(redeclare type SignalType = SI.AngularVelocity)
         "speed of axis flange";
      Interfaces.RealPort acceleration_ref(redeclare type SignalType =
            SI.AngularAcceleration) "reference acceleration of axis flange";
      Interfaces.RealPort acceleration(redeclare type SignalType =
            SI.AngularAcceleration) "acceleration of axis flange";
      Interfaces.RealPort current_ref(redeclare type SignalType = SI.Current)
        "reference current of motor";
      Interfaces.RealPort current(redeclare type SignalType = SI.Current)
        "current of motor";
      Interfaces.RealPort motorAngle(redeclare type SignalType = SI.Angle)
        "angle of motor flange";
      Interfaces.RealPort motorSpeed(redeclare type SignalType =
...
"),
      ...
      Modelica.Blocks.Interfaces.BusAdaptors.ReceiveReal current_ref
        annotation (extent=[-100, -80; -80, -60], rotation=90);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal motorSpeed
        annotation (extent=[45, -84; 65, -64], rotation=-90);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal motorAngle
        annotation (extent=[66, -84; 86, -64], rotation=-90);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal current
        annotation (extent=[-30, -87; -10, -67], rotation=-90);
    equation
      ...
      connect(hall1.outPort, hall2.inPort) annotation (points=[6, -50; -62, -50],
           style(
          pattern=3,
          thickness=1,
          arrow=0));
      ...
      connect(speed.outPort, motorSpeed.inPort)
        annotation (points=[55, -51; 55, -62], style(color=3));
      connect(phi.outPort, motorAngle.inPort)
        annotation (points=[76, -50; 76, -62], style(color=3));
      connect(motorSpeed.toBus, bus.motorSpeed) annotation (points=[55, -85; 55,
             -95; 80, -95; 80, -106], style(color=77));
      connect(motorAngle.toBus, bus.motorAngle) annotation (points=[76, -85; 76,
             -95; 80, -95; 80, -101], style(color=77));
      connect(current_ref.fromBus, bus.current_ref) annotation (points=[-90, -81;
             -90, -95; 80, -95; 80, -108], style(color=77));
      connect(current_ref.outPort, Vs.inPort) annotation (points=[-90, -59; -90,
             -40; -105, -40; -105, 4.28612e-016; -97, 4.28612e-016], style(
            color=3));
    initial equation
      ...
      der(La.i) = 0;
    equation
      connect(hall1.outPort, current.inPort) annotation (points=[6, -50; 6, -60;
             -20, -60; -20, -65], style(color=3));
      connect(current.toBus, bus.current) annotation (points=[-20, -88; -20, -95;
             80, -95; 80, -102], style(color=77));
    end Motor;
    ...
    model Controller
      ...
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal current_ref
        annotation (extent=[80, -60; 100, -40], rotation=270);
      Modelica.Blocks.Interfaces.BusAdaptors.ReceiveReal angle_ref
        annotation (extent=[-80, -60; -60, -40], rotation=90);
      Modelica.Blocks.Interfaces.BusAdaptors.ReceiveReal speed_ref
        annotation (extent=[-100, -60; -80, -40], rotation=90);
      Modelica.Blocks.Interfaces.BusAdaptors.ReceiveReal motorAngle
        annotation (extent=[-46, -60; -26, -40], rotation=90);
      Modelica.Blocks.Interfaces.BusAdaptors.ReceiveReal motorSpeed
        annotation (extent=[0, -60; 20, -40], rotation=90);
    equation
      connect(gain1.outPort, feedback1.inPort1)
        annotation (points=[-49, 10; -44, 10]);
      connect(feedback1.outPort, P.inPort)
        annotation (points=[-27, 10; -18, 10]);
      connect(P.outPort, add3.inPort2) annotation (points=[5, 10; 18, 10]);
      connect(gain2.outPort, add3.inPort1)
        annotation (points=[-39, 50; 10, 50; 10, 18; 18, 18], style(color=3));
      connect(speed_ref.outPort, gain2.inPort)
        annotation (points=[-90, -39; -90, 50; -62, 50], style(color=3));
      connect(motorAngle.outPort, feedback1.inPort2)
        annotation (points=[-36, -39; -36, 2], style(color=3));
      connect(motorSpeed.outPort, add3.inPort3)
        annotation (points=[10, -39; 10, 2; 18, 2], style(color=3));
      connect(current_ref.toBus, bus.current_ref) annotation (points=[90, -62;
            90, -80; 0, -80; 0, -101], style(color=77));
      connect(angle_ref.fromBus, bus.angle_ref) annotation (points=[-70, -61; -70,
             -80; 0, -80; 0, -101], style(color=77));
      connect(speed_ref.fromBus, bus.speed_ref) annotation (points=[-90, -62; -90,
             -80; 0, -80; 0, -101], style(color=77));
      connect(motorAngle.fromBus, bus.motorAngle) annotation (points=[-36, -62;
             -36, -80; 0, -80; 0, -104], style(color=77));
      connect(motorSpeed.fromBus, bus.motorSpeed) annotation (points=[10, -61;
            10, -80; 0, -80; 0, -104], style(color=77));
      connect(angle_ref.outPort, gain1.inPort) annotation (points=[-70, -39; -70,
             -30; -80, -30; -80, 10; -72, 10], style(color=3));
      connect(add3.outPort, PI.inPort)
        annotation (points=[41, 10; 58, 10], style(color=3));
      connect(PI.outPort, current_ref.inPort)
        annotation (points=[81, 10; 90, 10; 90, -38], style(color=3));
    end Controller;
...
"),
      ...
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal angle
        annotation (extent=[20, -80; 40, -60], rotation=-90);
      Modelica.Mechanics.Rotational.Sensors.AngleSensor angleSensor
        annotation (extent=[20, -50; 40, -30], rotation=-90);
      Modelica.Mechanics.Rotational.Sensors.SpeedSensor speedSensor
        annotation (extent=[60, -30; 40, -50], rotation=90);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal speed
        annotation (extent=[40, -80; 60, -60], rotation=-90);
      Modelica.Mechanics.Rotational.Sensors.AccSensor accSensor
        annotation (extent=[60, -50; 80, -30], rotation=-90);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal acceleration
    ...
    equation
      ...
      connect(speedSensor.outPort, speed.inPort)
        annotation (points=[50, -51; 50, -58], style(color=3));
      connect(angleSensor.outPort, angle.inPort)
        annotation (points=[30, -51; 30, -58], style(color=3));
      connect(angle.toBus, bus.angle) annotation (points=[30, -81; 30, -90; -90,
             -90; -90, 0; -106, 0], style(color=77));
      connect(speed.toBus, bus.speed) annotation (points=[50, -81; 50, -90; -90,
             -90; -90, 0; -104, 0], style(color=77));
      ...
      connect(accSensor.outPort, acceleration.inPort)
        annotation (points=[70, -51; 70, -58], style(color=3));
      connect(acceleration.toBus, bus.acceleration) annotation (points=[70, -81;
             70, -90; -90, -90; -90, 0; -103, 0], style(color=77));
    end AxisType1;
...
"),
      ...
      RobotR3.Components.AxisBus bus
        annotation (extent=[-120, -10; -100, 10], rotation=0);
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal angle
        annotation (extent=[20, -70; 40, -50], rotation=-90);
      Modelica.Mechanics.Rotational.Sensors.AngleSensor angleSensor
      ...
      Modelica.Blocks.Interfaces.BusAdaptors.SendReal acceleration
        annotation (extent=[60, -70; 80, -50], rotation=-90);
      Modelica.Mechanics.Rotational.Sensors.AccSensor accSensor
    ...
    equation
      ...
      connect(speedSensor.outPort, speed.inPort)
        annotation (points=[50, -41; 50, -48], style(color=3));
      connect(angleSensor.outPort, angle.inPort)
        annotation (points=[30, -40; 30, -48], style(color=3));
      connect(angle.toBus, bus.angle) annotation (points=[30, -71; 30, -80; -90,
             -80; -90, 0; -106, 0], style(color=77));
      connect(speed.toBus, bus.speed) annotation (points=[50, -71; 50, -90; -90,
             -90; -90, 0; -104, 0], style(color=77));
      connect(motor.flange_motor, gear.flange_a)
        annotation (points=[-10, 0; 0, 0], style(color=0));
      connect(gear.flange_b, accSensor.flange_a)
      ...
      connect(accSensor.outPort, acceleration.inPort)
        annotation (points=[70, -41; 70, -48], style(color=3));
      connect(acceleration.toBus, bus.acceleration) annotation (points=[70, -71;
             70, -90; -90, -90; -90, 0; -101, 0], style(color=77));
    end AxisType2;
...
"));
    public
      Modelica.Blocks.Interfaces.OutPort q(n=nout)
        annotation (extent=[100, 60; 120, 80]);
      Modelica.Blocks.Interfaces.OutPort qd(n=nout)
        annotation (extent=[100, -10; 120, 10]);
      Modelica.Blocks.Interfaces.OutPort qdd(n=nout)
...
<IMG SRC=\"../Images/Examples/Systems/robot_kr15.bmp\"
