...
<table border=1 cellspacing=0 cellpadding=2>
  ...
  <tr><td><b>FixedArrow,<br>SignalArrow</b></td>
      ...
      <IMG SRC=\"../Images/Arrow2.png\" ALT=\"model Visualizers.FixedArrow\">
      </td>
  </tr>
</table>
<p>
...
"),
      Icon(
        Polygon(points=[-100, 34; -100, -60; -10, -40; 50, -60; 50, 34; -10, 12;
               -100, 34], style(
            color=69,
            fillColor=69,
            fillPattern=1)),
        ...
        Text(
          ...
          style(color=0),
          string="%shapeType"),
        Text(extent=[-130, 118; 130, 58], string="%name")),
      Diagram);
    ...
    parameter Real extra=0.0
      "|if animation = true| Additional parameter for cylinder, cone, pipe, gearwheel and spring";
...
<IMG SRC=\"../Images/Arrow.png\" ALT=\"model Visualizers.FixedArrow\">
<p>
...
<IMG SRC=\"../Images/Arrow.png\" ALT=\"model Visualizers.SignalArrow\">
<p>
...
and are defined by parameters.
    ...
    protected
      ...
      MultiBody.Frames.Orientation R_rel=MultiBody.Frames.from_nxy(n_x, n_y);
      MultiBody.Frames.Orientation R_lines=MultiBody.Frames.absoluteRotation(R,
           R_rel);
      Real r_abs[3]=r + MultiBody.Frames.resolve1(R, r_lines);
      MultiBody.Visualizers.Advanced.Shape cylinders[n](
        each shapeType="cylinder",
        lengthDirection={MultiBody.Frames.resolve1(R_rel, vector([lines[i, 2, :]
             - lines[i, 1, :]; 0])) for i in 1:n},
        length={MultiBody.Frames.length(lines[i, 2, :] - lines[i, 1, :]) for i
             in 1:n},
        r={r_abs + MultiBody.Frames.resolve1(R_lines, vector([lines[i, 1, :]; 0]))
             for i in 1:n},
        each width=diameter,
        each height=diameter,
        each widthDirection={0,1,0},
