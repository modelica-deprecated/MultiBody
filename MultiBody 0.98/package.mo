  ...
  import "E:/otter/Modelica/library-design/MultiBody/libraries/DocumentationIcon.mo";
package MultiBody "Library to model the movement of 3-dimensional mechanical systems"

annotation (
  version="0.98",
  versionDate="2003-10-27",
  conversion(from(version="0.96", script="Scripts/ConvertTo_0.98.mos"), from(
        version="0.97", script="Scripts/ConvertTo_0.98.mos")),
  preferedView="info",
  Settings(NewStateSelection=true),
  Documentation(info="<HTML>
<p>
This library provides 3-dimensional mechanical components to model
in a convenient way <b>mechanical systems</b>, such as robots,
mechanisms, vehicles.
</p>

<ul>
<li> <a href=\"Modelica:MultiBody.Tutorial\">MultiBody.Tutorial</a>
     discusses the most important aspects to use library MultiBody.</li>
<li> <a href=\"Modelica:MultiBody.Examples\">MultiBody.Examples</a>
     contains examples that demonstrate the usage of this library.</li>
<li> <a href=\"Modelica:MultiBody.Tutorial.ReleaseNotes\">MultiBody.Tutorial.ReleaseNotes</a>
     summarizes the changes of the library releases.</li>
</ul>

<p>
It is planned to include the MultiBody library as
Modelica.Mechanics.MultiBody in the Modelica standard library
...
<li> The design of some of the icons, such as the frame connectors or the
     revolute joints, is from Hilding Elmqvist.</li>
...
<p>
<b>Version 0.96 (August 4, 2003)</b>
</p>
<p>
New Features:
</p>
<ul>
<li>MultiBody.Parts.BodyShape, MultiBody.Parts.BodyBox, and MultiBody.Parts.BodyCylinder<br>
    New option \"useQuaternions\" in the \"Advanced\" menu in order
    that optionally quaternions can be used as potential states instead of
    the 3 Cardan angles as it is also possible for MultiBody.Parts.Body. </li>
</ul>
<p>
Fixed Bugs:
</p>
<ul>
<li>MultiBody.Parts.Body<br>
    When body angles are used as states (e.g., for a free moving body),
    the result was wrong when phi[2] became larger as 80 degree.
    This has been fixed.</li>
<li>MultiBody.Parts.FixedRotation<br>
    If rotationType = PlanarRotationSequence, then 'angles'
    was interpreted as having unit [rad] instead of [deg].
    This has been fixed.</li>
</ul>
</HTML>"));
