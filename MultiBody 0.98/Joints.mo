...
"));
  ...
  model ActuatedPrismatic
    ...
    extends Internal.Prismatic(f=axis.f);
...
this force is an unknown quantity).
  ...
  model ActuatedRevolute
    ...
    extends Internal.Revolute(tau=axis.tau);
...
"),
  ...
  model Spherical "Spherical joint (3 constraints, no potential states)"
    extends MultiBody.Interfaces.PartialTwoFrames;
    parameter Boolean animation=true
                ...
                -s3, c3, 0;
                  0, 0, 1]*[c2, 0, -s2;
                            ...
                            s2, 0, c2]*[1, 0, 0;
                                        ...
                                        0, -s1, c1];
  */
    T_rel = [c2*c3, c1*s3 + s1*s2*c3, s1*s3 - c1*s2*c3; -c2*s3, c1*c3 - s1*s2*
    ...
    der(phi) = {w_rel_a[1] + (s1*w_rel_a[2] - c1*w_rel_a[3])*s2/c2a,c1*w_rel_a[
      2] + s1*w_rel_a[3],(-s1*w_rel_a[2] + c1*w_rel_a[3])/c2a};
    der(w_rel_a) = z_rel_a;
...
");
  ...
  */
    R_rel = Frames.relativeRotation(frame_a.R, frame_b.R);
    [f_ia_a, t_ia_a] = Frames.multipleResolve1(R_rel_ia, [frame_ia.f, frame_ia.
      t]);
...
component).
    ...
    protected
      ...
      Frames.Orientation R_ib_b "Rotation from frame_b to frame_ib";
...
");
      ...
      R_ib_b = Frames.relativeRotation(frame_b.R, frame_ib.R);
  ...
  */
      R_rel = Frames.relativeRotation(frame_a.R, frame_b.R);
      [f_c_a, t_cd_a] = Frames.multipleResolve1(R_ia_a, [frame_ia.f, frame_ia.t
         + frame_ib.t]);
      f_bd_a = -eAxis_a*f - e2_a*((n1_a*t_cd_a)/(axisLength*(n1_a*e3_a))) +
        e3_a*((e2_a*t_cd_a)/axisLength);
      zeros(3) = frame_b.f + Frames.resolve1(R_ib_b, frame_ib.f) -
        Frames.resolve2(R_rel, f_bd_a);
      zeros(3) = frame_b.t;
      ...
      if checkTotalPower then
        totalPower = frame_a.f*Frames.resolve2(frame_a.R, der(frame_a.r_0)) +
          ...
          Frames.angularVelocity2(frame_a.R, der(frame_a.R)) + frame_b.t*
          Frames.angularVelocity2(frame_b.R, der(frame_b.R)) + frame_ia.t*
          Frames.angularVelocity2(frame_ia.R, der(frame_ia.R)) + frame_ib.t*
          Frames.angularVelocity2(frame_ib.R, der(frame_ib.R)) + axis.f*der(
          axis.s) + bearing.f*der(bearing.s);
      else
        totalPower = 0;
      end if;
    end JointUPS;
...
<pre>
  ...
  */
      aux = cross(revolute.e, rRod2_ib)*Frames.resolve2(rod1.R_rel, rod1.eRod_a);
      rod1.f_rod = (-revolute.tau - revolute.e*(frame_ib.t + frame_im.t + cross(
        rRod2_ib, frame_im.f) - cross(rRod2_ib, Frames.resolve2(rod1.R_rel,
        rod1.f_b_a1))))/noEvent(if abs(aux) < 1.e-10 then 1.e-10 else aux);
      ...
      if checkTotalPower then
        totalPower = frame_a.f*Frames.resolve2(frame_a.R, der(frame_a.r_0)) +
          ...
          Frames.angularVelocity2(frame_b.R, der(frame_b.R)) + frame_ia.t*
          Frames.angularVelocity2(frame_ia.R, der(frame_ia.R)) + frame_ib.t*
          Frames.angularVelocity2(frame_ib.R, der(frame_ib.R)) + frame_im.t*
          Frames.angularVelocity2(frame_im.R, der(frame_im.R)) + axis.tau*der(
          axis.phi) + bearing.tau*der(bearing.phi);
      else
        totalPower = 0;
      end if;
      ...
      connect(rod1.frame_a, frame_a) annotation (points=[-94, 0; -110, 0],
          ...
          gradient=3,
          fillColor=8));
      connect(relativeSensor.frame_b, frame_a) annotation (points=[39, -80.1; -96,
             -80; -96, 0; -110, 0], style(
          color=0,
          thickness=2,
          gradient=3,
          fillColor=8));
      connect(relativeSensor.frame_a, frame_b) annotation (points=[61.05, -80;
            96, -80; 96, 0; 110, 0], style(
          color=0,
          thickness=2,
          gradient=3,
          fillColor=8));
...
<pre>
  ...
  */
      defineRoot(frame_ib.R);
      aux = prismatic.e*Frames.resolve2(rod1.R_rel, rod1.eRod_a);
      rod1.f_rod = (-prismatic.f - prismatic.e*(frame_ib.f + frame_im.f -
        Frames.resolve2(rod1.R_rel, rod1.f_b_a1)))/noEvent(if abs(aux) < 1.e-10
      ...
      if checkTotalPower then
        totalPower = frame_a.f*Frames.resolve2(frame_a.R, der(frame_a.r_0)) +
          ...
          Frames.angularVelocity2(frame_ia.R, der(frame_ia.R)) + frame_ib.t*
          Frames.angularVelocity2(frame_ib.R, der(frame_ib.R)) + frame_im.t*
          Frames.angularVelocity2(frame_im.R, der(frame_im.R)) + axis.f*der(
          axis.s) + bearing.f*der(bearing.s);
      else
        totalPower = 0;
      end if;
      ...
      connect(rod1.frame_a, frame_a) annotation (points=[-94, 0; -110, 0],
          ...
          gradient=3,
          fillColor=8));
      connect(relativeSensor.frame_b, frame_a) annotation (points=[29, -80.1; -97,
             -80; -97, 0; -110, 0], style(
          color=0,
          pattern=3,
          thickness=2,
          gradient=3,
          fillColor=8));
      connect(relativeSensor.frame_a, frame_b) annotation (points=[51.05, -80;
            95, -80; 95, 0; 110, 0], style(
          color=0,
          pattern=3,
          gradient=3,
          fillColor=8));
  ...
  */
      ...
      if checkTotalPower then
        totalPower = frame_a.f*Frames.resolve2(frame_a.R, der(frame_a.r_0)) +
          ...
          Frames.resolve2(frame_im.R, der(frame_im.r_0)) + frame_a.t*
          Frames.angularVelocity2(frame_a.R, der(frame_a.R)) + frame_b.t*
          Frames.angularVelocity2(frame_b.R, der(frame_b.R)) + frame_ib.t*
          Frames.angularVelocity2(frame_ib.R, der(frame_ib.R)) + frame_im.t*
          Frames.angularVelocity2(frame_im.R, der(frame_im.R)) + axis.tau*der(
          axis.phi) + bearing.tau*der(bearing.phi) + (-rod1Mass)*(der(rod1.
          v_CM_0) - world.gravityAcceleration(rod1.r_CM_0))*rod1.v_CM_0;
      else
        totalPower = 0;
      end if;
      ...
      connect(rod1.frame_a, frame_a) annotation (points=[-91, 0; -110, 0],
          ...
          gradient=3,
          fillColor=8));
      connect(relativeSensor.frame_b, frame_a) annotation (points=[39, -80.1; -95,
             -80; -95, 0; -110, 0], style(
          color=0,
          thickness=2,
          gradient=3,
  ...
  */
      ...
      if checkTotalPower then
        totalPower = frame_a.f*Frames.resolve2(frame_a.R, der(frame_a.r_0)) +
          ...
          Frames.angularVelocity2(frame_ib.R, der(frame_ib.R)) + frame_im.t*
          Frames.angularVelocity2(frame_im.R, der(frame_im.R)) + axis.f*der(
          axis.s) + bearing.f*der(bearing.s) + (-rod1Mass)*(der(rod1.v_CM_0) -
...
");
      ...
      Frames.Orientation R_rel_inv
        "Relative orientation object from frame_b to frame_a";
...
"));
    protected
      ...
      Real r_rel_a[3]
        "Position vector from origin of frame_a to origin of frame_b, resolved in frame_a";
      SI.Force f_c[2] "Constraint forces in direction of npx,npy";
    ...
    equation
      ...
      if not planarCutJoint then
        ...
        R_rel = Frames.planarRotation(e, angle);
        R_rel_inv = Frames.inverseRotation(R_rel);
        frame_b.r_0 = frame_a.r_0;

        if rooted(frame_a.R) then
          frame_b.R = Frames.absoluteRotation(frame_a.R, R_rel);
          [frame_a.f, frame_a.t] = -Frames.multipleResolve1(R_rel, [frame_b.f,
            frame_b.t]);
        else
          frame_a.R = Frames.absoluteRotation(frame_b.R, R_rel_inv);
          [frame_b.f, frame_b.t] = -Frames.multipleResolve1(R_rel_inv, [frame_a
            .f, frame_a.t]);
        end if;
        ...
        // Determine relative quantities
        r_rel_a = Frames.resolve2(frame_a.R, frame_b.r_0 - frame_a.r_0);
        R_rel = Frames.relativeRotation(frame_a.R, frame_b.R);
        R_rel_inv = Frames.inverseRotation(R_rel);

        // Define planar constraints
        nnpx = if e[1] > 0 or e[1] < 0 then {0,1,0} else {1,0,0};
        npy = cross(e, nnpx);
        npx = cross(npy, e);
        0 = npx*r_rel_a;
        0 = npy*r_rel_a;
...
connected to the prismatic joint.");
      ...
      SI.Velocity v(stateSelect=if enforceStates then StateSelect.always else
            StateSelect.default) "First derivative of s (relative velocity)";
      SI.Acceleration a;
