...
"),
  ...
  model FrameForce
    ...
    import SI = Modelica.SIunits;
    Interfaces.Frame_a frame_resolve
...
"),
  ...
  equation
    if cardinality(frame_resolve) == 0 then
      ...
      [frame_b.f, frame_b.t] = -Frames.multipleResolve2(Frames.relativeRotation(
        frame_resolve.R, frame_b.R), [inPort.signal[1:3], inPort.signal[4:6]]);
      frame_resolve.f = zeros(3);
      frame_resolve.t = zeros(3);
    end if;
...
<p>
In example
<a href=\"Modelica://MultiBody.Examples.Elementary.ForceAndTorque\">
MultiBody.Examples.Elementary.ForceAndTorque</a> the usage of this
general force element is shown. The composition diagram of this example
is displayed in the figure below. A \"ForceAndTorque\" element is connected
...
<IMG SRC=\"../Images/Examples/Elementary/ForceAndTorque1.png\">
<p>
...
"),
  ...
  equation
    ...
    f_b_0 = Frames.resolve1(frame_b.R, frame_b.f);
    zeros(3) = frame_a.f + Frames.resolve2(frame_a.R, f_b_0);
    zeros(3) = frame_a.t + Frames.resolve2(frame_a.R, Frames.resolve1(frame_b.R,
       frame_b.t) + cross(r_0, f_b_0));
  end ForceAndTorque;
