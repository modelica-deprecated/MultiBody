encapsulated model DoublePendulum
...
ALT=\"model Examples.Elementary.DoublePendulum\">
  ...
  MultiBody.Joints.ActuatedRevolute revolute1(initType=MultiBody.Types.
        Init.PositionVelocity) annotation (extent=[-48, 0; -28, 20]);
