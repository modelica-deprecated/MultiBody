...
user interface when the type is used as parameter in a declaration.
  ...
  type AngularVelocity_degs = Real (final quantity="AngularVelocity", final
        unit="deg/s");
  ...
  package RotationTypes
    ...
    type Temp
      ...
      annotation (Evaluate=true, choices(
          choice=MultiBody.Types.RotationTypes.RotationAxis "Rotation axis",
          choice=MultiBody.Types.RotationTypes.TwoAxesVectors
            "Two axes vectors",
          choice=MultiBody.Types.RotationTypes.PlanarRotationSequence
  ...
  package GravityTypes
    ...
    type Temp
      ...
      extends Integer;
      annotation (choices(
          choice=MultiBody.Types.GravityTypes.NoGravity "no gravity",
          choice=MultiBody.Types.GravityTypes.UniformGravity "uniform gravity",

          choice=MultiBody.Types.GravityTypes.PointGravity "point gravity"));
  ...
  package Init
    ...
    type Temp
      ...
      annotation (choices(
          ...
          choice=MultiBody.Types.Init.SteadyState
            "initialize in steady state (velocity and acceleration are zero)",
          choice=MultiBody.Types.Init.Position
            "initialize only generalized position variable(s)",
          choice=MultiBody.Types.Init.Velocity
            "initialize only generalized velocity variable(s)",
          choice=MultiBody.Types.Init.VelocityAcceleration
            "initialize generalized velocity and acceleration variables",
          choice=MultiBody.Types.Init.PositionVelocityAcceleration
